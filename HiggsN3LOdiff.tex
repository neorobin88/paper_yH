...
%   \left[
%     \sigma^{F\,\tot}_{\N{n}\LO} - 
%     \sigma^{F\,\tot}_{\N{n-1}\LO}
%   \right] +
%   \int_0^\infty\rd\qt^2 \left[
%     \frac{\rd\sigma^{F\,\fin}_{\N{n}\LO}}{\rd\qt^2} -
%     \frac{\rd\sigma^{F\,\fin}_{\N{n1}\LO}}{\rd\qt^2}
%   \right]
%   &= 
%   \asOpi^n \cH^{F;(n)} \otimes \sigma^F_{\LO}
%   \label{hn}
% \end{align}
