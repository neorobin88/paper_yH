...
In Fig.~\ref{fig:finiten3lo} we display the $\sigma_{F=H}^{(\rm fin.)}$ (i.e.\ ${\hat \sigma}_{H}^{(\rm fin.)}$ convoluted with the parton distribution functions) cross section at $\rm N^3LO$-only as a function of the $\qtcut$. With $\rm N^3LO$-only we denote  the difference $\Bigl[ \sigma_{H}^{(\rm fin.)}\Bigr]_{\rm N^{3}LO} - \Bigl[ \sigma_{H}^{(\rm fin.)}\Bigr]_{\rm NNLO}$. 
...
%\end{tabular}
%\end{center}
%\caption{\label{fig:CN3}{The numerically extracted $C_{N3}$ coefficient as defined in Eq.~\eqref{CN3eq} (black points) for the case of  $\qtcut=1$~GeV. The black error bars for each $C_{N3}$ point are obtained propagating the statistical uncertainties of the different terms involved in the computation. The red band represents the 
%extraction at $\mu=M_H/2$, which is subsequently used as default.}}
%\end{figure}
...
ÊÊJHEP {\bf 1305} (2013) 110
%ÊÊdoi:10.1007/JHEP05(2013)110
ÊÊ[arXiv:1212.2621].
ÊÊ%%CITATION = doi:10.1007/JHEP05(2013)110;%%
...
ÊÊJHEP {\bf 1512} (2015) 097
%ÊÊdoi:10.1007/JHEP12(2015)097
ÊÊ[arXiv:1503.00005].
ÊÊ%%CITATION = doi:10.1007/JHEP12(2015)097;%%
...
ÊÊJHEP {\bf 1202} (2012) 056
ÊÊÊ[arXiv:1112.3554].
ÊÊ%%CITATION = doi:10.1007/JHEP02(2012)056;%%
...
ÊÊJHEP {\bf 0908} (2009) 058
ÊÊÊ[arXiv:0906.0008].
ÊÊ%%CITATION = doi:10.1088/1126-6708/2009/08/058;%%
...
ÊÊJHEP {\bf 1001} (2010) 036
ÊÊÊ[arXiv:0909.4475].
ÊÊ%%CITATION = doi:10.1007/JHEP01(2010)036;%%
...
ÊÊJHEP {\bf 0912} (2009) 035
ÊÊ[arXiv:0910.4481].
ÊÊ%%CITATION = doi:10.1088/1126-6708/2009/12/035;%%
...
ÊÊJHEP {\bf 0405} (2004) 064
ÊÊ[hep-ph/0404013].
ÊÊ%%CITATION = doi:10.1088/1126-6708/2004/05/064;%%
  %59 citations counted in INSPIRE as of 20 Jul 2018
...
ÊÊJHEP {\bf 0412} (2004) 015
ÊÊ[hep-th/0411092].
ÊÊ%%CITATION = doi:10.1088/1126-6708/2004/12/015;%%
...
ÊÊJHEP {\bf 0503} (2005) 023
ÊÊ[hep-th/0412275].
ÊÊ%%CITATION = doi:10.1088/1126-6708/2005/03/023;%%
